...
public class dataServer extends simpleServer {
        ...
        public void start(int port) {
            try {
                ...
                while (true) { // keep listening until server is stopped
...
//            }
        ...
        public static class RequestDTO { // public because it is used in extensions of the enclosing class
